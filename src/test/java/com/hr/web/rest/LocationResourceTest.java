...
public class LocationResourceTest {
    ...
    private static final String DEFAULT_STATE_PROVINCE = "SAMPLE_TEXT";
    private static final String UPDATED_STATE_PROVINCE = "UPDATED_TEXT";
    ...
    public void setup() {
        ...
        this.restLocationMockMvc = MockMvcBuilders.standaloneSetup(locationResource).setMessageConverters(jacksonMessageConverter).build();
    }
    ...
    public void updateLocation() throws Exception {
        ...
        // Update the location
        location.setStreetAddress(UPDATED_STREET_ADDRESS);
        location.setPostalCode(UPDATED_POSTAL_CODE);
        location.setCity(UPDATED_CITY);
        location.setStateProvince(UPDATED_STATE_PROVINCE);
