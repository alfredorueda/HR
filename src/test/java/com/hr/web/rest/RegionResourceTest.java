...
public class RegionResourceTest {
    ...
    private static final String DEFAULT_REGION_NAME = "SAMPLE_TEXT";
    private static final String UPDATED_REGION_NAME = "UPDATED_TEXT";
    ...
    public void setup() {
        ...
        this.restRegionMockMvc = MockMvcBuilders.standaloneSetup(regionResource).setMessageConverters(jacksonMessageConverter).build();
    }
