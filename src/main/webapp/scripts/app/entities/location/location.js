    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('location', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'hrApp.location.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('location.detail', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'hrApp.location.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('location.new', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function($stateParams, $state, $modal) {
                    $modal.open({
                        ...
                        resolve: {
                            entity: function () {
                                return {streetAddress: null, postalCode: null, city: null, stateProvince: null, id: null};
                            }
                        }
